...
These plugins all target Kotlin 1.9.21 and Java 17 (for Kotlin/JVM apps).
...
- Adds dependencies and repository definitions so that a fixed version of Kotlin (currently 1.9.21) is used to compile the plugin.
- Targets Java 11.
